				...
				<div class="meta-box-sortables">
					<div class="postbox wpos-pro-box">
						...
						<div class="inside">
							...
							<a class="button button-primary wpos-button-full button-orange" href="<?php echo esc_url( BDPW_PLUGIN_LINK_UNLOCK ); ?>" target="_blank"><?php esc_html_e('Try Pro For 5 Days Free', 'blog-designer-for-post-and-widget'); ?></a>
						</div><!-- .inside -->
					</div><!-- #general -->
