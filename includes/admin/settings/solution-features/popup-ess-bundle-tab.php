...
<div id="bdpw_unlock_tabs" class="bdpw-vtab-cnt bdpw_unlock_tabs bdpw-clearfix">
			...
			<tr>
				...
				<td>
					<ul class="wpos-slider-list">
						...
						<li><span style="color:#2271b1; font-weight: bold;">Blog Designer - Post and Widget</span></li>
						<li>Trending/Popular Post Slider and Widget</li>
						<li>WP Featured Content and Slider</li>
						<li>Timeline and History slider</li>
	...
	<div class="bdpw-favourite-section">
		<h3 class="bdpw-blue bdpw-favourite-heading">Use Essential Plugin Bundle</h3>
		<h1 class="bdpw-favourite-sub-heading">With Your Favourite Page Builders</h1>
		<span><i class="dashicons dashicons-yes"></i> = <img src="<?php echo esc_url( BDPW_URL ); ?>assets/images/essential-logo-small.png" width="15" height="15" /> Essential Plugin Bundle contain many more layouts and designs</span>
	</div>
